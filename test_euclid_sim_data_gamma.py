...
def create_maps(n_side,intpu_file_name,z_bounds,mask_file_name,output_path):
    col_ra = 0
    col_dec = 1
    col_z = 2
    col_gamma_1 = 4
    ...
    c2m = catalogue_to_healpix_map_tools.converter(intpu_file_name,col_ra,col_dec,col_z,col_gamma_1,col_gamma_2,n_side,z_bounds,mask_file_name)
...
if __name__ == "__main__":
    if len(sys.argv) == 7 :
        ...
        create_maps(n_side,intpu_file_name,z_bounds,mask_file_name,output_path)
        
        print ""
        print (time.time() - start_time) / 60.0, 'minutes'
    else:
        print "usage: python ",sys.argv[0], "<nside> <input_file> <z_min> <z_max> <mask_file>  <output_path>"
